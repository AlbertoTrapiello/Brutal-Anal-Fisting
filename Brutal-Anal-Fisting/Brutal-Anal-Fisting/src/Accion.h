...
public:
	...
	virtual int get_option(istream &i=cin);//gestiona la opcion elegida por el usuario, parte logica
...
public:
	...
	Gestion_tropas(int id, bool right, int tropas, int opcion) :IAccion(id, right), tropas(tropas), opcion(opcion), my_menu("images/Troops.png", 1) { my_menu.setCenter(1, 0);	my_menu.setSize(7, 7); }
...
public:
	...
	Comercio(int id, bool right, int opcion, int cantidad) :IAccion(id, right),opcion(opcion), cantidad(cantidad), my_menu("images/Comercio.png", 1) { my_menu.setCenter(1, 0);	my_menu.setSize(7, 7); }
	ostream & print_options(ostream &o = cout);
	int get_option(istream &i=cin);
	bool check(int id);
	bool gestion_acc(Jugadores & j1, Jugadores & j2);//parte logica
...
public:
	...
	Diplomacia(int id, bool right, int amistad, int opcion) :IAccion(id, right), amistad(amistad), opcion(opcion), my_menu("images/Diplomacia.png", 1) { my_menu.setCenter(1, 0);	my_menu.setSize(7, 7); }
	ostream & print_options(ostream &o = cout);
	int get_option(istream &i=cin);
	bool check(int id);
	bool gestion_acc(Jugadores & j1, Jugadores & j2);//parte logica
...
public:
	...
	Mejorar(int id, bool right) :IAccion(id, right), my_menu("images/Mejorar.png", 1) { my_menu.setCenter(1, 0);	my_menu.setSize(7, 7); }
	ostream & print_options(ostream &o = cout);
	int get_option(istream &i=cin);
	bool check(int id);
	bool gestion_acc(Jugadores & j1, Jugadores & j2);//parte logica
